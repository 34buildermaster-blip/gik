      ...
      <section className="relative overflow-hidden bg-white px-5 py-20 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold leading-tight text-[#17211c] sm:text-6xl">
              เห็นวิธีทำงานจริง ก่อนเริ่มโปรเจกต์ของคุณ
            </h2>
          </div>
          <div>
            <p className="max-w-3xl text-xl leading-9 text-[#667169]">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {updateTopics.map((topic) => (
                <div key={topic.number} className="border-l-2 border-[#0f6b45] pl-4">
                  ...
                  <h3 className="mt-2 text-xl font-semibold text-[#17211c]">{topic.title}</h3>
                  <p className="mt-2 text-base leading-7 text-[#667169]">{topic.detail}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="live-updates-section px-5 py-20 text-[#17211c] lg:px-8 lg:py-24">
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <p className="max-w-xl text-xl leading-9 text-[#667169]">
            ...
            {projectUpdates.map((update) => (
              <article key={update.title} className="project-update-card section-card group">
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-3 text-2xl font-semibold leading-snug text-[#17211c]">{update.title}</h3>
                  <p className="mt-3 text-lg leading-8 text-[#667169]">{update.detail}</p>
                </div>
              </article>
            ))}
          </div>
