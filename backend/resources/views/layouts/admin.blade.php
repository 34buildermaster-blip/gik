...
<head>
    ...
    <title>{{ $title ?? '34 Build Master Admin' }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar {
            background: linear-gradient(180deg, rgba(5,57,32,.98), rgba(17,36,22,.98));
            color: white;
            padding: 28px 22px;
            position: sticky;
            top: 0;
        ...
        .brand-title { font-weight: 900; text-transform: uppercase; letter-spacing: .12em; line-height: 1.1; }
        .brand-sub { color: var(--gold); font-size: 12px; text-transform: uppercase; letter-spacing: .2em; }
        ...
        h1 { margin: 8px 0 0; font-size: clamp(32px, 5vw, 58px); line-height: 1.05; color: var(--green); }
        ...
        .thumb { width: 110px; height: 74px; object-fit: cover; border-radius: 14px; background: #e8dfca; }
        .badge {
            display: inline-flex;
            border-radius: 999px;
            padding: 6px 12px;
        ...
        .auth-card { width: min(100%, 480px); padding: 28px; }
